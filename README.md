...
Flutter_Mall是一款Flutter开源在线商城应用程序，是基于[mall](https://github.com/leoxiaoge/mall)基础上进行开发，mall包含了Spring Boot后端 + Vue管理员前端 + 微信小程序用户前端 + Vue用户移动端感兴趣的同学可以自行研究部署，Flutter_Mall基本上包含了mall中小程序的功能。<br>
